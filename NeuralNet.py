...
num_classes = 1
learning_rate = 1e-4
batch_size = 8  # has to work with random_split
num_epochs = 200

# Load Data
ppg_dataset = customDataset(
    'dataset/brno-university-of-technology-smartphone-ppg-database-but-ppg-1.0.0/quality-hr-ann.csv',
    'dataset/brno-university-of-technology-smartphone-ppg-database-but-ppg-1.0.0')
train_set, test_set = torch.utils.data.random_split(ppg_dataset, [40, 8])
...
# Loss and optimizer
criterion = nn.BCEWithLogitsLoss(pos_weight=torch.tensor(13/35))
...
def check_accuracy(loader, model):
    ...
    # Tell network you are still testing/training
    model.train()
